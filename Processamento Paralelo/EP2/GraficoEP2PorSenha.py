...
ax1.set_title('EP2 - Por Senha', fontsize=fontSize+3, fontweight='bold')
...
leg = ax1.legend(handles, labels, bbox_to_anchor=(0.85, 0.98), loc=2, borderaxespad=0., fontsize=fontSize)
...
plt.savefig('GraficoEp2PorSenha.pdf',bbox_inches='tight')
