...
[409836,	420666,		407920,		407023,		402765,		413389,		397831,		404292,		396829,		400849,		410031,		408751,		397474,		411249 ]
]
...
# EP1Seq = np.sqrt(EP1Seq)

# EP1BST2 = np.sqrt(EP1BST2)

# EP1BST3 = np.sqrt(EP1BST3)

# EP1BST4 = np.sqrt(EP1BST4)

# EP1BST8 = np.sqrt(EP1BST8)

# EP1Paralel2 = np.sqrt(EP1Paralel2)

# EP1Paralel3 = np.sqrt(EP1Paralel3)

# EP1Paralel4 = np.sqrt(EP1Paralel4)

# EP1Paralel8 = np.sqrt(EP1Paralel8)

# EP1Hash = np.sqrt(EP1Hash)
...
## Media e desvio padra	o ##


plt.errorbar(np.array(range(len(mediaEP1Seq)))*2, mediaEP1Seq, stdEP1Seq,label=r'EP1Seq', color='#FF0000', fmt='o', lw=1, capsize=4, markersize=8, markeredgecolor='#FF3333', markerfacecolor='#CC0000')
plt.plot(np.array(range(len(mediaEP1Seq)))*2, mediaEP1Seq, color='#CC2828',lw=2)

plt.errorbar(np.array(range(len(mediaEP1BST2)))*2, mediaEP1BST2, stdEP1BST2,label=r'EP1BST2', color='#AAFF00', fmt='s', lw=1, capsize=4, markersize=8, markeredgecolor='#BBFF33', markerfacecolor='#88CC00')
plt.plot(np.array(range(len(mediaEP1BST2)))*2, mediaEP1BST2, color='#96CC28',lw=2)

plt.errorbar(np.array(range(len(mediaEP1BST3)))*2, mediaEP1BST3, stdEP1BST3,label=r'EP1BST3', color='#D5FF00', fmt='v', lw=1, capsize=4, markersize=8, markeredgecolor='#DEFF33', markerfacecolor='#ABCC00')
plt.plot(np.array(range(len(mediaEP1BST3)))*2, mediaEP1BST3, color='#B1CC28',lw=2)

plt.errorbar(np.array(range(len(mediaEP1BST4)))*2, mediaEP1BST4, stdEP1BST4,label=r'EP1BST4', color='#FFFF00', fmt='^', lw=1, capsize=4, markersize=8, markeredgecolor='#FFFF33', markerfacecolor='#CCCC00')
plt.plot(np.array(range(len(mediaEP1BST4)))*2, mediaEP1BST4, color='#CCCC28',lw=2)

plt.errorbar(np.array(range(len(mediaEP1BST8)))*2, mediaEP1BST8, stdEP1BST8,label=r'EP1BST8', color='#FFD500', fmt='D', lw=1, capsize=4, markersize=8, markeredgecolor='#FFDE33', markerfacecolor='#CCAB00')
plt.plot(np.array(range(len(mediaEP1BST8)))*2, mediaEP1BST8, color='#CCB128',lw=2)

plt.errorbar(np.array(range(len(mediaEP1Paralel2)))*2, mediaEP1Paralel2, stdEP1Paralel2,label=r'EP1Paralel2', color='#00FF00', fmt='.', lw=1, capsize=4, markersize=8, markeredgecolor='#33FF33', markerfacecolor='#00CC00')
plt.plot(np.array(range(len(mediaEP1Paralel2)))*2, mediaEP1Paralel2, color='#28CC28',lw=2)

plt.errorbar(np.array(range(len(mediaEP1Paralel3)))*2, mediaEP1Paralel3, stdEP1Paralel3,label=r'EP1Paralel3', color='#00FF2A', fmt='h', lw=1, capsize=4, markersize=8, markeredgecolor='#33FF54', markerfacecolor='#00CC21')
plt.plot(np.array(range(len(mediaEP1Paralel3)))*2, mediaEP1Paralel3, color='#28CC43',lw=2)

plt.errorbar(np.array(range(len(mediaEP1Paralel4)))*2, mediaEP1Paralel4, stdEP1Paralel4,label=r'EP1Paralel4', color='#00FF55', fmt='*', lw=1, capsize=4, markersize=8, markeredgecolor='#33FF77', markerfacecolor='#00CC44')
plt.plot(np.array(range(len(mediaEP1Paralel4)))*2, mediaEP1Paralel4, color='#28CC5F',lw=2)

plt.errorbar(np.array(range(len(mediaEP1Paralel8)))*2, mediaEP1Paralel8, stdEP1Paralel8,label=r'EP1Paralel8', color='#00FF80', fmt='>', lw=1, capsize=4, markersize=8, markeredgecolor='#33FF9A', markerfacecolor='#00CC67')
plt.plot(np.array(range(len(mediaEP1Paralel8)))*2, mediaEP1Paralel8, color='#28CC7B',lw=2)

plt.errorbar(np.array(range(len(mediaEP1Hash)))*2, mediaEP1Hash, stdEP1Hash,label=r'EP1Hash', color='#FF00FF', fmt='x', lw=1, capsize=4, markersize=8, markeredgecolor='#FF33FF', markerfacecolor='#CC00CC')
plt.plot(np.array(range(len(mediaEP1Hash)))*2, mediaEP1Hash, color='#CC28CC',lw=2)
...
ax1.set_title('EP1', fontsize=fontSize+3, fontweight='bold')
...
plt.savefig('GraficoEP1.pdf',bbox_inches='tight')
