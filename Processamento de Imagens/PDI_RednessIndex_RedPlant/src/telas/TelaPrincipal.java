...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Detecção Por Índice Redness - \"Vegetation Redness RI” - André Couto");
        ...
        jMenu5.setText("Vegetation Redness RI");
    ...
    private void jMenuItem9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem9ActionPerformed
        ...
        if(imagemFoiCarregada){
            ...
            if(retorno ==JFileChooser.APPROVE_OPTION){   
                File fo = new File(fs.getSelectedFile().getPath() + (extRedness ? "_RedPlant" : "") + (extOtsu ? "_OTSU" : "") + ".png");
                try {
    ...
    private void jMenuItem13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem13ActionPerformed
        JFrame f=new JFrame();
        JOptionPane.showMessageDialog(f, "Programa desenvolvido e implementado por André Couto em 2021/2, \nNa Disciplina de PDI tendo sido ministrada pelo Prof. Jacques Facon.");
    ...
    private void jMenuItem18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem18ActionPerformed
        ...
        if(imagemFoiCarregada){
            try{
                BufferedImage imagemPosterizada = ProcessamentoImagem.riRedPlant(imagemAtual); 
